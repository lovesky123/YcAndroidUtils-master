...
public final class YcSPUtils {
     ...
     * @return the single {@link YcSPUtils} instance
     */
    public static YcSPUtils getInstance() {
        return getInstance("");
    }
    ...
    private YcSPUtils(final String spName) {
        sp = YcUtils.getContext().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }
